      ...
      >
        <div className='flex flex-col'>
          ...
          <div className='flex flex-col h-screen overflow-y-auto overflow-x-hidden text-7xl pt-20 gap-5 p-7'>
            ...
            laborum suscipit natus beatae, mollitia blanditiis illo, minus
            libero sapiente obcaecati quae, rem fugiat velit omnis error quod
            cum similique. Error aut repellendus accusamus officiis doloremque
            repudiandae fuga delectus quaerat earum illum! Optio ducimus cumque
            modi ipsa provident
          </div>
        </div>
      </div>
